...
This is a fork of Mastodon.

See original repository: https://github.com/mastodon/mastodon
...
.logo.logo--wordmark,
.navigation-panel__sign-in-banner, .sign-in-banner,
.logo--icon,
...
.compose-form .compose-form__warning, .compose-form .compose-form__warning a, .reply-indicator__content a, .status__content a,
...
.interaction-modal__login__input.focused {
background-color: transparent !important;
}
